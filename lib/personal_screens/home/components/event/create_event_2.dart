...
import 'package:mycommunity/personal_screens/home/components/event/publish_event.dart';
import 'package:mycommunity/personal_screens/home/components/event/rounded_address_field.dart';
import 'package:mycommunity/personal_screens/home/components/event/rounded_location_link_field.dart';
import 'package:mycommunity/personal_screens/home/components/event/rounded_voluteering_detail_field.dart';
...
class CreateEvent_2 extends StatefulWidget{
  final String title, description, category, volunteer;
  final DateTime dateTimeStart, dateTimeEnd;
  final File? image;

  const CreateEvent_2({Key? key, required this.title, required this.description, required this.category, required this.dateTimeStart, required this.dateTimeEnd,
    required this.volunteer, required this.image}) : super(key: key);

  @override
  _CreateEvent_2 createState() => _CreateEvent_2();
}

class _CreateEvent_2 extends State<CreateEvent_2> {
                              ...
                              child:ElevatedButton(
                                onPressed: ()  {
                                  if (_formKey.currentState!.validate() && address != "" && _selectedLocation != null) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => PublishEvent(title: widget.title, description: widget.description, image: widget.image,
